...
export class CreateViolationDto {
  @ApiProperty({
    ...
    description: 'The unit associated with the violation.',
  })
  @IsUUID()
  @IsNotEmpty()
  unitId: string;
  ...
  @ApiProperty({
    ...
    description: 'The resident committing the violation (optional).',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    example: 500.0,
    description: 'The fine amount in currency units.',
  })
  @IsNumber()
  @Min(0)
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    description: 'Date the fine must be paid by (Admin specified).',
  })
  @IsDateString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 'ADMIN_UUID',
    description: 'ID of the staff member issuing this.',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class UpdateViolationDto extends PartialType(CreateViolationDto) {
  @ApiProperty({
    ...
    description: 'Update status (e.g., APPEALED, CANCELLED).',
  })
  ...
  @ApiProperty({
    ...
    description: 'Notes on the appeal status.',
    required: false,
  })
  @IsString()
  @IsOptional()
